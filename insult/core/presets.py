...
PRESET_GUIDANCE: dict[PresetMode, str] = {
    PresetMode.DEFAULT_ABRASIVE: (
        ...
        "- You can insult, but each one should reveal something — about them, about the topic, about the gap in their thinking.\n"
    ...
    PresetMode.PLAYFUL_ROAST: (
        ...
        "- AVOID: actually hurtful jabs, punching down, mean-spiritedness disguised as humor.\n"
...
def classify_preset(
    ...
    3. RELATIONAL_PROBE — emotional signals
    4. INTELLECTUAL_PRESSURE — technical/argumentative signals
    5. PLAYFUL_ROAST — humor/banter signals
    6. DEFAULT_ABRASIVE — fallback
    """
    ...
    # --- Priority 4: INTELLECTUAL_PRESSURE ---
